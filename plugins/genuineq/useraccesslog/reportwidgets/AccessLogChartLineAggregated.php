<?php namespace Genuineq\UserAccessLog\ReportWidgets;
 ...
 *
 * @package namespace Genuineq\UserAccessLog\ReportWidgets
 */
class AccessLogChartLineAggregated extends ReportWidgetBase
{
	...
	public function defineProperties()
	{
		return [
			'title' => [
				'title' => 'genuineq.useraccesslog::lang.reportwidgets.chartlineaggregated.title',
				'default' => 'Access statistics in time',
				'type' => 'string',
				'validationPattern' => '^.+$',
				'validationMessage' => 'genuineq.useraccesslog::lang.reportwidgets.chartlineaggregated.title_validation',
			],
            'days' => [
                'title' => 'genuineq.useraccesslog::lang.reportwidgets.chartlineaggregated.days_title',
                'default' => '30',
                'type' => 'string',
