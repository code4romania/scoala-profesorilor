...
class AccessLogChartLine extends ReportWidgetBase
{
	...
	public function defineProperties()
	{
		return [
			'title' => [
                'title' => 'genuineq.useraccesslog::lang.reportwidgets.chartline.title',
                'default' => 'Access statistics in time each user',
				'type' => 'string',
				'validationPattern' => '^.+$',
				'validationMessage' => 'genuineq.useraccesslog::lang.reportwidgets.chartline.title_validation',
			],
            'days' => [
                'title' => 'genuineq.useraccesslog::lang.reportwidgets.chartline.days_title',
                'default' => '30',
                'type' => 'string',
