...
class Users extends Controller
{
     ...
     */
    public $requiredPermissions = ['genuineq.users.access_users'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Genuineq.User', 'user', 'users');
        SettingsManager::setContext('Genuineq.User', 'settings');
    }

    public function index()
    {
        $this->addJs('/plugins/genuineq/user/assets/js/bulk-actions.js');
    ...
    public function formExtendFields($form)
    {
         ...
         */
        if (
            UserSettings::get('login_attribute') == User::$loginAttribute &&
    ...
    public function preview_onUnban($recordId = null)
    {
        ...
        Flash::success(Lang::get('genuineq.user::lang.users.unbanned_success'));
    ...
    public function preview_onConvertGuest($recordId)
    {
        ...
        Flash::success(Lang::get('genuineq.user::lang.users.convert_guest_success'));
    ...
    {
        if (!$this->user->hasAccess('genuineq.users.impersonate_user')) {
        ...
        Flash::success(Lang::get('genuineq.user::lang.users.impersonate_success'));
    }
    ...
    public function preview_onUnsuspendUser($recordId)
    {
        ...
        Flash::success(Lang::get('genuineq.user::lang.users.unsuspend_success'));
    ...
    public function index_onBulkAction()
    {
        if (
            ...
            Flash::success(Lang::get('genuineq.user::lang.users.'.$bulkAction.'_selected_success'));
        }
        else {
            Flash::error(Lang::get('genuineq.user::lang.users.'.$bulkAction.'_selected_empty'));
        }
