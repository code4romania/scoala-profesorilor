<?php namespace Genuineq\User\Tests\Unit\Facades;

use Auth;
use Genuineq\User\Models\User;
use Genuineq\User\Tests\PluginTestCase;
...
class AuthFacadeTest extends PluginTestCase
{
    public function test_registering_a_user()
    {
        ...
        $this->assertInstanceOf('Genuineq\User\Models\User', $user);
    ...
    public function test_registering_a_guest()
    {
        ...
        $this->assertEquals(1, User::count());
        $this->assertInstanceOf('Genuineq\User\Models\User', $guest);
