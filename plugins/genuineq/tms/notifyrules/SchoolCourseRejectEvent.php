...
class SchoolCourseRejectEvent extends EventBase
{
    /**
    ...
    {
        return [
            'name'        => 'School Course Reject',
            'description' => 'A school rejected a course requested by a teacher',
            'group'       => 'tms'
        ];
    }
    ...
    public static function makeParamsFromEvent(array $args, $eventName = null)
    {
        ...
        $params['notification-type'] = 'school-course-reject';
