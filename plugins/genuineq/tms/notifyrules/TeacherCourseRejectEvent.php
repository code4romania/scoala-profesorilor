...
class TeacherCourseRejectEvent extends EventBase
{
    /**
    ...
    {
        return [
            'name'        => 'Teacher Course Reject',
            'description' => 'A teacher rejected a course proposed by a school',
            'group'       => 'tms'
        ];
    }
    ...
    public static function makeParamsFromEvent(array $args, $eventName = null)
    {
        ...
        $params['notification-type'] = 'teacher-course-reject';
