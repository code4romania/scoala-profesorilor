...
class BuilderTableCreateGenuineqCoursesCourses extends Migration
{
    public function up()
    {
        Schema::create('genuineq_courses_courses', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('genuineq_courses_courses');
    }
}
