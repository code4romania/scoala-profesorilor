...
class BuilderTableCreateGenuineqCoursesCategories extends Migration
{
    public function up()
    {
        Schema::create('genuineq_courses_categories', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('genuineq_courses_categories');
    }
}